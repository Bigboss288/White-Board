...
const Panel = ({ addNoteToArray, set_shape, setColor, undo_click, clear }) => {
  ...
  // document.querySelector(".main-color").addEventListener("click", open_color_palette);
  ...
  return (
    <div className="panel-container">
      <div>
        <button className="button" onClick={set_shape_rect}>
        ...
        <button className="button" onClick={set_shape_circle}>
        ...
        <button className="button" onClick={set_shape_line}>
        ...
        <button className="button" onClick={set_shape_linear}>
        ...
        <div className="main-color" onClick={open_color_palette}>
          <div className="color-palette">
            ...
            <div className="color-3" onClick={() => set_color("rgb(3, 197, 3)")}></div>
          </div>
        </div>
      </div>
      <div>
